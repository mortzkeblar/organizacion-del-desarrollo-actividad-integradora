...
describe('Test database', () => {
  ...
  describe('Validate insertion', () => {
    ...
    test('Insert a user without city', async () => {
      const query = `INSERT INTO
                     users (email, username, birthdate, first_name, last_name, password, enabled)
    ...
    test('Insert a user without the first name', async () => {
      const query = `INSERT INTO
                     users (email, username, birthdate, city,  last_name, password, enabled)
    ...
    test('Insert a user without the last name', async () => {
      const query = `INSERT INTO
                     users (email, username, birthdate, city,  first_name, password, enabled)
    ...
    test('Insert a user without the password', async () => {
      const query = `INSERT INTO
                     users (email, username, birthdate, city, first_name, last_name, enabled)
    ...
    test('Insert a user with an invalid value in the enabled field', async () => {
      const query = `INSERT INTO
                     users (email, username, birthdate, city, first_name, last_name, password, enabled)
                     VALUES ('user@example.com', 'user', 'invalid_date', 'La Plata', 'Juan', 'Perez', 'hashed_pass_123', 1952)`

      await expect(client.query(query)).rejects.toThrow('invalid input syntax for type date')
    })
    test('Insert a user with an invalid value in the created_at field', async () => {
      const query = `INSERT INTO
                     users (email, username, birthdate, city, first_name, last_name, password, enabled, created_at)
                     VALUES ('user@example.com', 'user', 'invalid_date', 'La Plata', 'Juan', 'Perez', 'hashed_pass_123', true, 1982)`

      await expect(client.query(query)).rejects.toThrow('invalid input syntax for type date')
    })
    test('Insert a user with an invalid value in the updated_at field', async () => {
      const query = `INSERT INTO
                     users (email, username, birthdate, city, first_name, last_name, password, enabled, updated_at)
                     VALUES ('user@example.com', 'user', 'invalid_date', 'La Plata', 'Juan', 'Perez', 'hashed_pass_123', true, 1982)`
    ...
    test('Insert a user with an invalid value in the last_access_time field', async () => {
      const query = `INSERT INTO
                     users (email, username, birthdate, city, first_name, last_name, password, enabled, last_access_time)
                     VALUES ('user@example.com', 'user', 'invalid_date', 'La Plata', 'Juan', 'Perez', 'hashed_pass_123', true, 1982)`
